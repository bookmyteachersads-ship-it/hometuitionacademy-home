      ...
      <div className="sm:border border-grayLight grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 max-w-6xl mx-auto bg-white mt-4 before:absolute before:right-0 before:w-[300px] before:bg-grayLight before:h-full max-md:before:hidden">
        <div>
          ...
          <ul className="mt-4 flex flex-wrap justify-center gap-6">
            ...
            <li className="flex items-center text-primary">
              ...
              <a href="tel:+917715889123" className="text-sm ml-4">
                <strong>+91 77158 89123</strong>
              </a>
            </li>
          </ul>
        </div>
        <div className="z-10 relative h-full max-md:min-h-[350px]">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8341133.179600359!2d61.75978660356398!3d19.22558335464256!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b0d69fa2bc33%3A0x27bc2c5377c96cf7!2sHome%20Tuition%20Academy!5e1!3m2!1sen!2sin!4v1787317172552!5m2!1sen!2sin"
            width="600"
            height="450"
            style={{ border: 0 }}
            allowFullScreen=""
