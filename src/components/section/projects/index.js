...
const ProjectList = ({ selectedCategory = null }) => {
        ...
        <div className="w-full bg-slate-50 py-3 rounded-t-xl">
          <div className="flex flex-col gap-2 text-center my-2 xl:my-5 xl:px-[15%]">
            ...
            <p className="text-xs font-me">
              ...
              through innovative technology solutions. From idea to execution,
              our case studies showcase proven results, measurable success, and
              the expertise we bring to every project.
            </p>
          </div>
        </div>
